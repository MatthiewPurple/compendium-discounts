...
[assembly: MelonInfo(typeof(CompendiumDiscounts), "Compendium Discounts", "1.0.0", "Matthiew Purple but mostly Zephhyr let's be honest")]
[assembly: MelonGame("アトラス", "smt3hd")]

namespace compendium_discounts;
public class CompendiumDiscounts : MelonMod
{
    public const float limitDiscount = 100f; // What the discount scales towards the closer you get to 100% compendium completion
